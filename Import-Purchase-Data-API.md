...
| is_anonymous | boolean | 是否為匿名訂單(此欄位為支援會員訂單與匿名訂單同時匯入的場景, 只有當 API 參數的 is_anonymous=False 時才會查看此欄位, 當 API 參數的 is_anonymous=True 而匯入資料中又有此欄位時會報錯)<br><br>範例: `True/False` | | |
